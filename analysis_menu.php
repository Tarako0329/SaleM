...
<?php
    $array = [
        ...
        ,'ｲﾍﾞﾝﾄ別客単価ﾗﾝｷﾝｸﾞ'=>['analysis_uriagejisseki.php?sum_tani=7&csrf_token='.$token,'イベントごとの平均客単価を算出し、ランキングを表示。']
        ...
        ,'エリア別客単価ﾗﾝｷﾝｸﾞ'=>['analysis_uriagejisseki.php?sum_tani=Area_tanka_1&csrf_token='.$token,'エリアごとの客単価を算出し、ランキングを表示。']
        ,'客単価実績(ｲﾍﾞﾝﾄ開催ごと)'=>['analysis_uriagejisseki.php?sum_tani=6&csrf_token='.$token,'日ごとの平均客単価を表示します。']
