...
if(csrf_chk()===false){
    ...
    //更新モード(実行)
    $sql = "update UriageData set tanka = :tanka,updDatetime=now() where UriDate between :w_date_from and :w_date_to";

    $up_sqllog = "update UriageData set tanka = '".$_POST["up_uritanka"]."' , updDatetime=now() where UriDate between '".$_POST["w_date_from"]."' and '".$_POST["w_date_to"]."'";
