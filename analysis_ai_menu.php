...
$ai_settings_def = [
	[
		...
		/*'your_ask' => "レポートの構成は次の通り。
			・目標と現状の確認及び、目標達成ための提案（季節、今後のイベントごとなどを考慮）。
			・月ごとの売上推移を棒グラフと表で表示
			・季節別売上トップ５の表と表から見た分析結果。
			・ABC分析の表をもとに、注力すべき商品とそうでない商品の選定。
			・商品大分類別の売上集計結果を分析。円グラフを表示。
			・商品大中分類別の売上集計結果を分析。円グラフを表示。
			・商品大中小分類別の売上ランキング結果を分析。
			・イベント別平均売上表から、出るべきイベントの取捨選択
			・平均売上トップ10のイベントにおける商品の売上トップ10から注力する製品を分析
			・地域、天気と売上の関連。
			・売上が期待できる住所エリア
			・取扱商品から見る業種の傾向と今後のトレンド。
			・SNSを利用している場合、ビジネス情報を元にSNS毎の活用方法、有効なハッシュタグについて。
			・売上分析用データとビジネス情報を元に今後の成長戦略の立案
			・商品ごとの売上ランキング表TOP10とワースト10を表示",*/
		'your_ask' => "レポートの構成は次の通り。
			...
			5. 商品分類別売上分析
			商品大分類別の売上集計結果を分析し、円グラフで表示します。
			商品大中分類別の売上集計結果を分析し、円グラフで表示します。
			商品大中小分類別の売上ランキング結果を分析します。
			6. イベント戦略
			イベント別平均売上表から、参加すべきイベントとそうでないイベントを取捨選択します。
			平均売上トップ10のイベントにおける商品の売上トップ10の表を作成・分析し、注力すべき製品を特定します。
			7. 地域・天気と売上の関連性
